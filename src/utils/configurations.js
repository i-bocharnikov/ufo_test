...
configurations.UFO_SERVER_PRIVATE_API_URL = `${configurations.UFO_SERVER_API_URL}api/`;
configurations.UFO_SERVER_PUBLIC_API_URL = `${configurations.UFO_SERVER_API_URL}public/api/`;
