...
export default class UFOTextInput_old extends React.Component {
  render() {
    ...
    const numberOfLines = this.props.numberOfLines ? this.props.numberOfLines : 1;
    const multiline = this.props.multiline ? this.props.multiline : false;
    ...
    const autoCorrect = this.props.autoCorrect ? this.props.autoCorrect : false;
    const autoCapitalize = this.props.autoCorrect ? 'sentences' : 'none';
    ...
    const onChangeText = this.props.onChangeText && editable ? this.props.onChangeText : () => null;
    return (
