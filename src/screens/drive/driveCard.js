...
class DriveCard extends Component {
  render() {
    ...
    return (
      ...
      >
        <UFOText h3>{t("drive:rentalReference", { rental: rental })}</UFOText>
        <UFOImage
        ...
        {rental.message_for_driver !== undefined &&
          rental.message_for_driver !== null &&
          rental.message_for_driver !== "" && (
            <UFOText h4 italic center style={{ marginTop: 10 }}>
              {rental.message_for_driver}
            </UFOText>
          )}
      </View>
